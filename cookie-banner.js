...
(function () {
    ...
    /* ============================================================
       ATUALIZAR TOGGLE DO COOKIE NO RODAPÉ (AG5 Skill)
       ============================================================ */
    function updateFooterToggleIcon() {
        ...
        if (prefs && prefs.decided) {
            // Se aceitou qualquer cookie opcional, mostrar como ativo (bolinha à direita)
            if (prefs.functional || prefs.analytics || prefs.performance || prefs.advertising) {
                toggle.classList.remove('inactive');
                toggle.classList.add('active');
            } else {
                // Se rejeitou todos os opcionais (apenas necessários), mostrar como inativo (bolinha à esquerda)
    ...
    function init() {
        ...
        // Primeira visita — mostra o banner e define toggle como ativo
        updateFooterToggleIcon();
